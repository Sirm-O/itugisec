              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Utugi Secondary School</p>
                    <p className="text-gray-600">Utugi, Kenya</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@utugi.ac.ke</p>
                    <p className="text-gray-600">admissions@utugi.ac.ke</p>
                  </div>
                </div>
              </div>
            </div>
